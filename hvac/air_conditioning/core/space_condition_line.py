...
class SpaceConditionLine:
    ...
    def W_ai(self, T_ai: Quantity) -> Quantity:
        """Solve space condition line for `W_ai` if `T_ai` is given."""
    ...
    def T_ai(self, W_ai: Quantity) -> Quantity:
        """Solve space condition line for `T_ai` if `W_ai` is given."""
    ...
    def start_point(self, dT_db: Quantity = Q_(50, 'delta_degC')) -> StatePoint:
        ...
        ----------
        dT_db: Quantity
            difference between dry-bulb temperature of start point and the space air dry-bulb temperature
    ...
    def end_point(self, dT_db: Quantity = Q_(50, 'delta_degC')) -> StatePoint:
        ...
        ----------
        dT_db: Quantity
            difference between dry-bulb temperature of end point and the space air dry-bulb temperature
